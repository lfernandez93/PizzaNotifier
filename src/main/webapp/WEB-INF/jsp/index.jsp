        ...
        <div class="wrapper">
            <div class="main">
                ...
                <div class="page-container">
                    <form class="bl_form">
                        <input type="email" value=""  class="label_better" data-new-placeholder="Email Address" placeholder="Email Address">
                        <input type="submit" class="reload btn" value="Subscribe"/>
                    </form>
                </div>
            </div>
        </div>
